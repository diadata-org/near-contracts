//
// SUPPLY DIAAPI TEST CONTRACT/EXAMPLE
//
...
impl Default for SupplyTestContract {
    fn default() -> Self {
...
mod tests {
    ...
    fn test_id() {
        initialize();
        /* Initialize contract */
        let mut contract = super::SupplyTestContract::new();
